...
\end{tabularx}
\captionof{table}{Overview of grand prix, with circuit data. 'Turn' column defines sides, left or right for both the first turn and the pole position.}\label{table:results}\\
